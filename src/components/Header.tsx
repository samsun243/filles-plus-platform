        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:block relative group">
              <button className="p-2 text-gray-500 hover:text-rose-600 transition-colors rounded-full hover:bg-rose-50">
                <Search size={20} />
              </button>
            </div>
            ...
            <div className="px-4 pt-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all"
                />
              </div>
            </div>
          </nav>
